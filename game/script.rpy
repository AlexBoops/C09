...
screen pause_menu():
    ...
    on "show" action Function(game_pause)
    ...
    add "gui/nvl.png"
    hbox:
        frame style "main_menu"
    add "gui/ClassOf09logo.png" at transform_logo
    vbox:
        xalign 0.5
        yalign 0.5
        textbutton _("Resume") activate_sound "audio/MainMenuPress.mp3" hover_sound "audio/MainMenuRollover.mp3" action Function(game_unpause)
        textbutton _("Options") activate_sound "audio/MainMenuPress.mp3" hover_sound "audio/MainMenuRollover.mp3" action ShowMenu('pause_prefs')
        textbutton _("Save") activate_sound "audio/MainMenuPress.mp3" hover_sound "audio/MainMenuRollover.mp3" action ShowMenu('pause_save')
        textbutton _("Main Menu") activate_sound "audio/MainMenuPress.mp3" hover_sound "audio/MainMenuRollover.mp3" action [Stop("vo"),Stop("ambient"),MainMenu()]
init style pause_menu_button_text size 200
init style skip_button_text size 50
...
label scene_0011:
    ...
    show pills full:
        percrightcenter
        linear 0.12:
            xalign 0.455 yalign 0.65 rotate 345.0
    ...
    show pills full:
        ...
        linear 0.15:
            yalign 0.9 xalign 0.55 rotate 30.0
    ...
    show pills full:
        ...
        linear 0.75:
            yalign 2.0 xalign 0.4 rotate 270
